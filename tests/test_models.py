...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_none_existent_product(self):
    ...
    def test_deserialize_missing_data(self):
        """It should raise DataValidationError when deserializing with missing data"""
        product = Product()
        data = {
            "description": "A hat",  # Missing name, price, and category
            "price": "12.50",
            "available": True,
            # 'category' is missing
        }
    ...
    def test_deserialize_invalid_available_type(self):
        ...
        data = {
            ...
            "price": "12.50",
            "available": "yes",  # Should be boolean, not string
            "category": "CLOTHS"
        }
        with self.assertRaises(DataValidationError) as context:
            product.deserialize(data)
    ...
    def test_deserialize_invalid_price_type(self):
        """It should raise DataValidationError when 'price' is not a valid number"""
        product = Product()
        data = {
            "name": "Fedora",
            "description": "A red hat",
        ...
        with self.assertRaises(InvalidOperation) as context:
            product.deserialize(data)
        self.assertIn("ConversionSyntax", str(context.exception))

    def test_deserialize_invalid_category(self):
        """It should raise DataValidationError when 'category' is not a valid enum"""
        product = Product()
        data = {
            "name": "Fedora",
            "description": "A red hat",
    ...
    def test_deserialize_valid_product(self):
        """It should successfully deserialize valid product data"""
        product = Product()
        data = {
            "name": "Fedora",
            "description": "A red hat",
    ...
    def test_deserialize_invalid_type(self):
        """It should raise DataValidationError when 'data' is of an invalid type"""
        product = Product()
        ...
        # Test with a string instead of a dictionary
        with self.assertRaises(DataValidationError) as context:
            product.deserialize("invalid_data")
        self.assertIn("Invalid product: body of request contained bad or no data", str(context.exception))

        # Test with an integer instead of a dictionary
        with self.assertRaises(DataValidationError) as context:
